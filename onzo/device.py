...
class Connection(object):
    ...
    #def __init__(self, vid=0x1d6b, pid=0x0002, unit=1): 
        self.vid = vid
        self.pid = pid
        self.unit = unit
    ...
    def connect(self):
        ...
        try:
           ...
           print(f"\nFailed to connect to Onzo Device. Using ID {self.vid:#0{6}x}:{self.pid:#0{6}x}. \nIs it connected and passed through from the host?\n", flush=True)
           exit()
